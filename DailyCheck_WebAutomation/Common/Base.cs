...
/*            //Name
        ...
        /// <summary>
        /// Gets the text of the alert and accepts it.
        /// </summary>
        /// <param name="driver">The WebDriver instance.</param>
        /// <returns>The text of the alert.</returns>

        //Objective: Gets the text of the alert and accepts it
        public static string GetAlertTextAndAccept(IWebDriver dr) //Written by Thanu
        {
            try
            {
            ...
            {
                Console.WriteLine("An error occurred while handling the alert: " + e.Message);
                return null;
            }
        }
        ...
        public static void switchToWindow(string title)  //Written by Thanu
        {
        ...
        public static void switchToWindowGetTitle(string configKey) //Written by Thanu
        {
